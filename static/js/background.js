var w = canvasNebulas.width = window.innerWidth,
  h = canvasNebulas.height = window.innerHeight,
  ctx = canvasNebulas.getContext('2d'),
...
window.addEventListener('resize', function () {
  ...
  w = canvasNebulas.width = window.innerWidth;
  h = canvasNebulas.height = window.innerHeight;
